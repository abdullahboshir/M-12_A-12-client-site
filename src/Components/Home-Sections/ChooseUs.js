    ...
    return (
        <div style={{ height: "695px", minWidth: "100%" }} className="bg-white flex justify-center items-center">
            ...
            <div style={{ boxSizing: "border-box", width: "100%", height: "600px" }} className='mb-24 flex pb-24 justify-center items-center h-4/6 relative shadow-lg bg-primary'>
                ...
                <div class=" w-52 h-52 rotate-45 rounded-xl bg-base-100 shadow-xl p-0 m-0  ">
                ...
                <div class=" w-52 h-52 rotate-45 rounded-xl bg-base-100 shadow-xl mt-64 ml-0">
                    <div class="card-body -rotate-45 flex justify-center items-center flex-col">
                ...
                <div class=" w-52 h-52 rotate-45 rounded-xl bg-base-100 shadow-xl">
                    <div class="card-body -rotate-45 flex justify-center items-center flex-col">
