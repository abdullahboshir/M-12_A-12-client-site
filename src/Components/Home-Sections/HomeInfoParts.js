...
const HomeInfoParts = () => {
    return (
        <div className='flex justify-between items-center h-full w-sreen px-16 mt-8 mb-28'>
            ...
            <div className='w-[600px] text-start mt-12'>
                <h1 className="text-5xl font-bold mb-4 text-secondary">Our stack is available</h1>
                <p>
                ...
                <button className="btn btn-active  mt-5 hover:bg-accent hover:border-transparent text-white ">learn More</button>
            </div>
